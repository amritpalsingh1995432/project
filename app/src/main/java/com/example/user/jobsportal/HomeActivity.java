...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lstJobseekerList = findViewById(R.id.lstJobList);
        //lstJobseekerList.setAdapter(new ListJobsAdapter (getApplicationContext()));
        //lstJobList = findViewById(R.id.lstJobList);
        //lstJobList.setAdapter(new ListJobsAdapter (getApplicationContext()));
        db = FirebaseFirestore.getInstance();
        listJobs = findViewById(R.id.alljobs2);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "You are not allowed to post a Job!", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();

                String new_string = user_email+"  "+user_type;
                Toast.makeText(getApplicationContext(), new_string,Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_location) {
            ...
            geoUri = "http://maps.google.com/maps?q=loc:" +
                    13.7733 + "," + 19.3360 + " (" + "Job Fair on 12/12/2020" + ")";
